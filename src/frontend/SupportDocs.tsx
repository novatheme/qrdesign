...
import { ArrowLeft, Book, Shield, Zap, Globe } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-50 font-sans">
            ...
            <main className="max-w-4xl mx-auto px-8 py-20 pb-40">
                ...
                >
                    ...
                    <h1 className="text-5xl font-black text-slate-900 tracking-tighter mb-4">Documentation & Support</h1>
                    ...
                    <div className="space-y-12">
                        {sections.map((section, i) => (
                            <div key={i} className="group p-8 bg-white border border-slate-200 rounded-[32px] hover:border-blue-500 transition-all shadow-sm">
